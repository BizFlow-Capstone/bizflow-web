...
export async function POST(
  ...
  try {
    ...
    const backendUrl = new URL(
      `${AI_BACKEND_API_URL}/api/my-business/ai/anomalies/${encodeURIComponent(id)}/acknowledge`,
    );
    ...
    console.error("Error acknowledging AI anomaly alert:", error);
    return NextResponse.json(
      {
        success: false,
        message: "Failed to acknowledge AI anomaly alert",
      },
      { status: 500 },
    );
  }
