...
/**
 * Tesseract helpers - extract numbers/prices from raw OCR text
 */
 ...
 * Looks for patterns like "Nhà cung cấp:", "Đơn vị bán:", "Công ty", address, tax ID, phone.
 */
 ...
 * Looks for "Ghi chú:", "Diễn giải:", "Nội dung:", etc.
 */
...
export default function ImportFormClient() {
  ...
  const currentLocation = useMemo(
    () => locations.find((l) => l.id === businessLocationId),
  ...
  const { data: productData, isLoading: isLoadingProducts } = useProducts({
    locationId: businessLocationId ?? 0,
    pageSize: 200,
  });
  ...
  const handleSaveAsDraft = async () => {
    if (!businessLocationId || !isValid) return;
    try {
  ...
  const handleHasInvoiceChange = (val: boolean) => {
    setHasInvoice(val);
    removeImage();
  };
      ...
      <div className="flex-1 flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-1">
            Vui lòng vào chi tiết kho hàng và nhấn nút &quot;Nhập Kho&quot;.
          </p>
          <Button
            variant="outline"
            ...
            <div className="px-8 py-5 space-y-4">
              ...
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={() => handleHasInvoiceChange(false)}
                    className={`flex items-center gap-2.5 px-5 py-3 rounded-lg border-2 transition-all ${
                      !hasInvoice
                        ? "border-[#23C4C1] bg-[#23C4C1]/5 text-[#23C4C1] shadow-sm"
                        : "border-gray-200 bg-white text-gray-600 hover:border-gray-300"
                  ...
                  <button
                    type="button"
                    onClick={() => handleHasInvoiceChange(true)}
                    className={`flex items-center gap-2.5 px-5 py-3 rounded-lg border-2 transition-all ${
                      hasInvoice
                        ? "border-[#23C4C1] bg-[#23C4C1]/5 text-[#23C4C1] shadow-sm"
                        : "border-gray-200 bg-white text-gray-600 hover:border-gray-300"
                  ...
                  {!invoiceImage ? (
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-[#23C4C1] transition-colors">
                      ...
                      <div className="flex justify-center gap-3">
                        ...
                        <Button
                          onClick={() => {
                            // On mobile, this triggers camera
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-gray-700">
                        {currentLocation
                          ? `${currentLocation.address}, ${currentLocation.district}, ${currentLocation.city}`
                          : "—"}
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
